 ...
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this create(int|string $objectType, array|Body\HubspotCrmCreateBody $requestBody) Create a CRM object with the given properties and return a copy of the object, including the ID.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method $this create(int|string $objectType, array|Body\HubspotCrmCreateBody $requestBody) Create a CRM object with the given properties and return a copy of the object, including the ID.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this update(int|string $objectType, int|string $objectId, array|Body\HubspotCrmUpdateBody $requestBody) Perform a partial update of an object identified by {objectId}.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method $this update(int|string $objectType, int|string $objectId, array|Body\HubspotCrmUpdateBody $requestBody) Perform a partial update of an object identified by {objectId}.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 ...
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this batchDelete(int|string $objectType, array|Body\HubspotBatchDeleteBody $requestBody) Archive a batch of objects by ID.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method $this batchDelete(int|string $objectType, array|Body\HubspotBatchDeleteBody $requestBody) Archive a batch of objects by ID.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this batchCreate(int|string $objectType, array|Body\HubspotBatchCreateBody $requestBody) Create a batch of objects.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method $this batchCreate(int|string $objectType, array|Body\HubspotBatchCreateBody $requestBody) Create a batch of objects.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this batchRead(int|string $objectType, array|Body\HubspotBatchReadBody $requestBody) Read a batch of objects by internal ID, or unique property values.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method $this batchRead(int|string $objectType, array|Body\HubspotBatchReadBody $requestBody) Read a batch of objects by internal ID, or unique property values.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this batchUpdate(int|string $objectType, array|Body\HubspotBatchUpdateBody $requestBody) Update a batch of objects.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method $this batchUpdate(int|string $objectType, array|Body\HubspotBatchUpdateBody $requestBody) Update a batch of objects.
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 ...
 * See https://developers.hubspot.com/docs/api/crm/crm-custom-objects
 *
 * @method static $this search(int|string $objectType, array|Body\HubspotSearchBody $requestBody) Search objects by {objectType}.
 * See https://developers.hubspot.com/docs/api/crm/search
 *
 * @method $this search(int|string $objectType, array|Body\HubspotSearchBody $requestBody) Search objects by {objectType}.
 * See https://developers.hubspot.com/docs/api/crm/search
 *
