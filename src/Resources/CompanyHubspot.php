...
* @method static $this get(int|string $companyId) Read an Object identified by {companyId}.
* @method $this get(int|string $companyId) Read an Object identified by {companyId}.
...
* @method static $this update(int|string $companyId, array $requestBody) Perform a partial update of an Object identified by {companyId}.
* @method $this update(int|string $companyId, array $requestBody) Perform a partial update of an Object identified by {companyId}.
* @method static $this delete(int|string $companyId) Move an Object identified by {companyId} to the recycling bin.
* @method $this delete(int|string $companyId) Move an Object identified by {companyId} to the recycling bin.
