...
* @method static $this get(int|string $productId) Read an Object identified by {productId}.
* @method $this get(int|string $productId) Read an Object identified by {productId}.
...
* @method static $this update(int|string $productId, array $requestBody) Perform a partial update of an Object identified by {productId}.
* @method $this update(int|string $productId, array $requestBody) Perform a partial update of an Object identified by {productId}.
* @method static $this delete(int|string $productId) Move an Object identified by {productId} to the recycling bin.
* @method $this delete(int|string $productId) Move an Object identified by {productId} to the recycling bin.
